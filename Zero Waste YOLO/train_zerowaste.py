...
Améliorations vs votre code original :
  ✓ Encodeur ResNet-18 pré-entraîné (vs U-Net from scratch)
  ✓ Normalisation ImageNet correcte
  ✓ Augmentations (flip, rotation, ColorJitter, flou)
  ✓ Focal Loss + Dice (vs CrossEntropy seule)
  ✓ Scheduler cosinus avec warmup
  ✓ Early stopping + sauvegarde du meilleur modèle
  ✓ Differential LR encodeur/décodeur
  ✓ Tout le dataset utilisé (pas limité à 30 images)
  ✓ Rapport final par classe + visualisations
